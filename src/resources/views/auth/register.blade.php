        ...
        <div class="col-lg-9">
            <div class="card">
                <div class="card-header sunny-morning-gradient mb-3">
                    <h4 class="text-center text-white mt-2">新規登録</h4>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row pb-2">
                            <label for="name" class="mt-2 col-md-4 text-md-right"><span class="text-danger">※</span>ニックネーム</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row pb-2">
                            <label for="email" class="mt-2 col-md-4 text-md-right"><span class="text-danger">※</span>メールアドレス</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row pb-2">
                            <label for="age" class="mt-2 col-md-4 text-md-right"><span class="text-danger">※</span>年齢</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row pb-2">
                            <label for="prefecture" class="mt-2 col-md-4 text-md-right"><span class="text-danger">※</span>都道府県</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row pb-2">
                            <label for="password" class="mt-2 col-md-4 text-md-right"><span class="text-danger">※</span>パスワード</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row pb-2">
                            <label for="password" class="mt-2 col-md-4 text-md-right"><span class="text-danger">※</span>パスワードの確認</label>
                            <div class="col-md-6">
